    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      ...
      >
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            <div className="font-semibold tracking-tight">ARC3</div>
            <div className="text-[11px] text-muted-foreground -mt-0.5">Marketing Audit</div>
          </div>
        </div>
